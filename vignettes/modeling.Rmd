...
## Daily Data: Preprocessing and Merging Tweets
...
## Weekly Data: Preprocessing and Merging (Soybean) Exports

```{r}
```

## Monthly Data: Preprocessing and Merging (Soybean) WASDE
...
print(pred_model_list$train_pred_df)
print(pred_model_list$test_pred_df)
```
